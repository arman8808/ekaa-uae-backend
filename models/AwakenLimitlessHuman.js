...
const awakenLimitlessHumanSchema = new mongoose.Schema(
  {
  ...
  { 
    timestamps: true,
    collection: "awaken_limitless_human_registrations" // Explicit collection name
  }
);

const AwakenLimitlessHuman = mongoose.model("AwakenLimitlessHuman", awakenLimitlessHumanSchema);

module.exports = AwakenLimitlessHuman;
