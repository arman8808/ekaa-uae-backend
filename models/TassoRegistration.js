...
const tassoRegistrationSchema = new mongoose.Schema(
  {
  ...
  {
    timestamps: true,
    collection: "tasso_registrations",
  }
);

module.exports = mongoose.model("TassoRegistration", tassoRegistrationSchema);
