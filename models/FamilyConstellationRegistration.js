...
const familyConstellationRegistrationSchema = new mongoose.Schema(
  {
  ...
  {
    timestamps: true,
    collection: "family_constellation_registrations",
  }
);

module.exports = mongoose.model(
  "FamilyConstellationRegistration",
  familyConstellationRegistrationSchema
);
